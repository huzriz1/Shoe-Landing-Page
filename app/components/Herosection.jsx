    ...
    <>
      <section
        style={{
          ...
          height: "90vh", // replace 64px with your actual navbar height
        }}
        ref={sectionRef}
        className="relative w-full flex flex-col md:flex-row items-center justify-center overflow-hidden"
      >
        {/* Parallax Image */}
        <div className="absolute inset-0 z-0 h-full w-full will-change-transform">
          <div
            style={{
              transform: `translateY(calc(${offset}px - 100px))`,
        ...
        {/* Content */}
        <div className="relative z-10 text-primary-foreground text-center pb-8 px-8 md:pb-16 md:px-16">
          ...
          <h1 className="text-4xl md:text-6xl tracking-tight leading-tight font-bold mb-4 typing-animation w-fit">
            Step into Style.
          </h1>
          <p className="text-lg md:text-xl mb-8">
            Experience the perfect blend of comfort and modern design.
          </p>
